            ...
            <table id="riwayat" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td>
                  ...
                  @elseif($konseling->status == 'rescheduled')
                    <span class="float-left badge bg-warning">Reschedule</span>
                  ...
                  <form class="" action="{{route('konselor.konseling.show')}}" method="post">
                    ...
                    {{--
                      ...
                      <div class="dropdown-menu" role="menu">
                        @if($konseling->status == 'succeed' || $konseling->status == 'canceled')
                        @else
                        <!-- <div class="dropdown-item"> -->
                          <form class="" action="{{route('konselor.konseling.update')}}" method="post">
                            @method('PUT')
                            @csrf
                            <input type="hidden" name="konseling_id" value="{{$konseling->id}}">
                        ...
                        <!-- </div> -->
                        @if($konseling->status != 'rescheduled')
                        <!-- <div class="dropdown-item"> -->
                        <form class="" action="{{route('konselor.konseling.update')}}" method="post">
                          @method('PUT')
                          @csrf
                        ...
                        <form class="" action="{{route('konselor.konseling.update')}}" method="post">
                          ...
                          @csrf
                          <input type="hidden" name="konseling_id" value="{{$konseling->id}}">
                          <input type="hidden" name="status" value="succeed">
                      ...
                      <span class="mr-2">Select Action</span>
                      </button>
                    --}}
                </td>
              </tr>
