              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <p>Bimbingan dan konseling merupakan  upaya proaktif dan sistematik dalam memfasilitasi individu mencapai tingkat perkembangan yang optimal, pengembangan perilaku yang efektif, pengembangan lingkungan, dan peningkatan fungsi atau manfaat individu dalam lingkungannya.</p>
                      <a class="btn btn-primary" href="{{route('mahasiswa.konseling.create')}}"><i class="fas fa-calendar-alt mr-3"></i>Jadwalkan Pertemuan</a>
                    </div>
                    <!-- /.card-body -->
                  </div>
                  <!-- /.card -->
