			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
						...
						<form class="" action="{{route('mahasiswa.konseling.store')}}" method="post">
							@csrf
							<div class="form-group">
                  <label>Konselor</label>
                  <select class="form-control select2bs4" name="konselor_id" style="width: 100%;">
											@foreach($listKonselor as $konselor)
													<option value="{{ $konselor->id }}">{{ $konselor->program_studi->nama }} - {{ $konselor->nama }} - {{ $konselor->nip }}
											@endforeach
                  </select>
              </div>
							...
							<div class="form-group">
								...
								<div class="input-group date" id="timepicker" data-target-input="nearest">
									...
									<input type="text" name="waktu_mulai" class="form-control datetimepicker-input" data-target="#timepicker" required/>
								</div>
								<!-- /.input group -->
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group" id="timepicker" data-target-input="nearest">
										<input type="text" class="form-control" name="tempat" value="Ruang BKP" placeholder="Ruang BKP" required/>
								</div>
							...
							<div class="form-group">
								...
								<div class="input-group" id="timepicker" data-target-input="nearest">
										<textarea class="form-control" name="deskripsi" placeholder="Ruang BKP"></textarea>
								</div>

							</div>
							<div class="form-group">
								<button type="submit"class="btn btn-primary" name="button">Ajukan Jadwal Pertemuan</button>
							</div>
						</form>
					</div>
				</div>
