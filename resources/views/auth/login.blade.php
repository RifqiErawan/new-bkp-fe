...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>BKP</b> Login Page</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Masuk untuk mengakses dashboard</p>

      <form action="{{ route('auth.login') }}" method="post">
        {{ csrf_field() }}
        <div class="input-group mb-3">
          <input type="unsername" name="username" class="form-control" placeholder="Email">
