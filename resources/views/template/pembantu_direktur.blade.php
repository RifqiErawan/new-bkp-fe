    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <form method="post" action="{{route('auth.logout')}}">
                        @csrf
                        <button class="nav-link btn btn-danger" type="submit"><i
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <a href="{{route('home')}}" class="brand-link">
                <img src="{{asset('assets/img/logo-polban.png')}}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="https://api.adorable.io/avatars/40/{{ \Session::get('credential')->user_data->profile->id }}"
                            class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="{{route('pembantu_direktur.dashboard')}}"
                            class="d-block">{{\Session::get('credential')->user_data->profile->nama }}</a>
                    </div>
                </div>
