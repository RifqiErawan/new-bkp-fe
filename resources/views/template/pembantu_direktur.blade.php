    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <?php if(\Session::get('credential')->user_data->roles[0]->name == "konselor"){ ?>
              <a href="{{route('konselor.profile')}}" class="d-block">{{\Session::get('credential')->user_data->profile->nama }}</a>
            <?php } else { ?>
              <a href="{{route('mahasiswa.profile')}}" class="d-block">{{\Session::get('credential')->user_data->profile->nama }}</a>
            <?php } ?>
